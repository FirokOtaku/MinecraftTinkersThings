 ...
 */
public class EntityAITemptPlayer extends EntityAIBase
{
	Predicate<EntityPlayer> temptor;
	public EntityAITemptPlayer(EntityLiving temptedEntityIn, double speedIn, boolean scaredByPlayerMovementIn, Predicate<EntityPlayer> temptor)
	{
	...
	public boolean shouldExecute()
	{
		...
		else
		{
			...
			{
				return this.isTemptingPlayer(temptingPlayer);
			}
		}
	}
	 ...
	 * 这个方法判断能否跟随玩家
	 */
	public boolean isTemptingPlayer(EntityPlayer player)
	{
		return temptor.test(player);
	}
