 ...
 * ;
 */
public class ContainerGemBrewingStand extends Container
{
...
//	private int prevFuel;
	...
	public ContainerGemBrewingStand(InventoryPlayer playerInventory, IInventory tileBrewingStandIn)
	{
		this.tileBrewingStand = tileBrewingStandIn;
		this.addSlotToContainer(new ContainerGemBrewingStand.Potion(tileBrewingStandIn, 0, 56, 51));
		this.addSlotToContainer(new ContainerGemBrewingStand.Potion(tileBrewingStandIn, 1, 79, 58));
		this.addSlotToContainer(new ContainerGemBrewingStand.Potion(tileBrewingStandIn, 2, 102, 51));
		this.slot = this.addSlotToContainer(new ContainerGemBrewingStand.Ingredient(tileBrewingStandIn, 3, 79, 17));
//		this.addSlotToContainer(new ContainerGemBrewingStand.Fuel(tileBrewingStandIn, 4, 17, 17));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			if ((index < 0 || index > 2) && index != 3 && index != 4)
			{
				...
				else if (ContainerGemBrewingStand.Potion.canHoldPotion(itemstack) && itemstack.getCount() == 1)
				{
...
//				else if (ContainerGemBrewingStand.Fuel.isValidBrewingFuel(itemstack))
//				{
